VclType PROC_ELEFANTCmd::Type = VclType::testTypeVCL;

void PROC_ELEFANTCmd::RequestParams::serialize(ISerialWriter& writer) const {
	// TODO
}

void PROC_ELEFANTCmd::RequestParams::deserialize(const ISerialReader& reader) {
	// TODO
}

bool PROC_ELEFANTCmd::RequestParams::equals(const PROC_ELEFANTCmd::RequestParams& other) const {
	// TODO
    return true;
}

std::string PROC_ELEFANTCmd::RequestParams::toString() const {
    std::stringstream stream;
    return stream.str();
}

void PROC_ELEFANTCmd::ReplyParams::serialize(ISerialWriter& writer) const {
	// TODO
}

void PROC_ELEFANTCmd::ReplyParams::deserialize(const ISerialReader& reader) {
	// TODO
}

bool PROC_ELEFANTCmd::ReplyParams::equals(const PROC_ELEFANTCmd::ReplyParams& other) const {
	// TODO
    return true;
}

std::string PROC_ELEFANTCmd::ReplyParams::toString() const {
    std::stringstream stream;
    return stream.str();
}
