...
namespace Tuvok{
	...
	namespace Renderer{
		...
		namespace OpenGL{
			...
			class GLGridLeaper2 : public AbstrRenderer{
			public:
				...
				GLGridLeaper2(std::shared_ptr<Context::Context> context,Core::Math::Vec2ui vWinSize = Core::Math::Vec2ui(640, 480), ERenderMode mode = RM_1DTRANS);
				~GLGridLeaper2();
