...
namespace trinity {
  ...
  public:
    ...
    virtual std::vector<MinMaxBlock> getBrickMaxMin() const = 0;
    ...
    virtual std::vector<std::shared_ptr<const std::vector<uint8_t>>> getBricks(const std::vector<BrickKey>& brickKeys, bool& success) const = 0;
