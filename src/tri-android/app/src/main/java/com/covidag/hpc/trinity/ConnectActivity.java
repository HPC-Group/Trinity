package com.covidag.hpc.trinity;
...
class ClientThread implements Runnable {
    ...
    private static final String SERVER_IP = "134.91.11.158";
    ...
    public void run() {
        try {
            ...
            Log.d(TAG, "SCOK CREATED");

            //byte[] message = ByteBuffer.allocate(4).putInt(3).array();
            int size = 7;
            byte[] message = new byte[11];
            message[3] = (byte)(size >>> 24);
            message[2] = (byte)(size >>> 16);
