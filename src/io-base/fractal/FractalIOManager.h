...
public:
    virtual std::shared_ptr<IOInterface> openFile(uint32_t id) const {
        switch (id) {
        case 3:
            return std::make_shared<FractalIO>(64, 64, 64, 64, 64, 64);
        case 4:
            return std::make_shared<FractalIO>(128, 128, 128, 128, 128, 128);
        case 5:
            return std::make_shared<FractalIO>(256, 256, 256, 256, 256, 256);
        case 6:
            return std::make_shared<FractalIO>(512, 512, 512, 32, 32, 32);
        case 7:
            return std::make_shared<FractalIO>(1024, 1024, 1024, 32, 32, 32);
        case 8:
            return std::make_shared<FractalIO>(2048, 2048, 2048, 32, 32, 32);
        case 9:
            return std::make_shared<FractalIO>(4096, 4096, 4096, 32, 32, 32);
        default:
