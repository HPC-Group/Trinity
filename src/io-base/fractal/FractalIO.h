...
namespace trinity {
  ...
  public:
    ...
    Core::Math::Vec3ui64 getDomainSize(uint64_t lod, uint64_t modality,
    ...
    uint64_t getLargestSingleBrickLOD(uint64_t modality,
                                      uint64_t ts) const override;
    ...
    Core::Math::Vec3ui getBrickLayout(uint64_t lod, uint64_t modality,
                                      uint64_t timestep) const override;
