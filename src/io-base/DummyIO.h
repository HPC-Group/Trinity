...
public:
    ...
    Core::Math::Vec3ui64 getDomainSize(uint64_t lod, uint64_t modality) const override {Core::Math::Vec3ui64 x; return x; }
    Core::Math::Mat4d getTransformation(uint64_t modality) const override {Core::Math::Mat4d x; return x; }
    Core::Math::Vec3ui getBrickOverlapSize() const override {Core::Math::Vec3ui x; return x; }
    uint64_t getLargestSingleBrickLOD(uint64_t modality) const override {uint64_t x; return x; }
    ...
    Core::Math::Vec3ui getBrickLayout(uint64_t lod, uint64_t modality) const override {Core::Math::Vec3ui x; return x; }
