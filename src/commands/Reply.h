...
public:
    ...
    static std::unique_ptr<Reply> createFromMessage(const mocca::net::Message& message, CompressionMode compressionMode);
    static mocca::net::Message createMessage(const Reply& reply, CompressionMode compressionMode);
