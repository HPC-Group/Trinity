...
TEST_F(CmdFactoryTest, WrongRequest) {
    ...
    InitProcessingSessionCmd::RequestParams requestParams("loopback", VclType::DummyRenderer, "FractalData@1",
...
TEST_F(CmdFactoryTest, RendererExecTest) {
    ...
    StreamingParams streamingParams(2048, 1000);
    InitProcessingSessionCmd::RequestParams requestParams("loopback", VclType::DummyRenderer, "FractalData@1", ioEndpoint, streamingParams);
    InitProcessingSessionRequest request(requestParams, 0, 0);
