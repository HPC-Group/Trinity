...
OpenGLWidget::OpenGLWidget(QWidget* parent)
    : QOpenGLWidget(parent), texture(0), program(0) {
...
void OpenGLWidget::paintGL() {
    glViewport(0, 0, this->width()*devicePixelRatio(), this->height()*devicePixelRatio());  // devicePixelRatio is needed for retina displays
