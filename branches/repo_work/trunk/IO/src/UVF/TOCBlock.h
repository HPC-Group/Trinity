...
public:
  ...
  void GetData(uint8_t* pData, Vec4ui64 coordinates) const;

  uint64_t GetLoDCount() const;
  Vec3ui64 GetBrickCount(uint64_t iLoD) const;
  Vec3ui64 GetBrickSize(Vec4ui64 coordinates) const;
  Vec3d GetBrickAspect(Vec4ui64 coordinates) const;
  Vec3ui64 GetLODDomainSize(uint64_t iLoD) const;
  const TOCEntry& GetBrickInfo(Vec4ui64 coordinates) const;

  uint64_t GetLinearBrickIndex(Vec4ui64 coordinates) const;
  ...
  Vec2ui GetAtlasSize(Vec4ui64 coordinates) const {
